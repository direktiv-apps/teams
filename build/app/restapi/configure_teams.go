...
//go:generate swagger generate server --target ../../app --name Teams --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/teams/build/templates --principal interface{}

func configureFlags(api *operations.TeamsAPI) {
...
func configureAPI(api *operations.TeamsAPI) http.Handler {
